...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="container py-16 px-4 sm:px-28" style={{ zIndex: "11px" }}>
        <section className="flex items-center">
          <img className="w-28 h-28" src="./assets/logo.png" alt="" />
          <p className="text-white text-4xl">MUSIVO <span><p className="text-sm">Let’s Play The Music</p></span></p>
        </section>
        <section>
                ...
                <div className="rounded-md shadow-sm-space-y-px">
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="appearance-none relative bg-transparent block w-full h-14 rounded-lg px-3 py-6 border border-gray-300 placeholder-gray-500 text-white focus:outline-none focus:ring-white-500 focus:border-white focus:z-10 sm:text-sm"
                      placeholder="Email"
                      value={email}
